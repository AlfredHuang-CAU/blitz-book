...
还有某一些东西我讲到烂了不想要讲了。比如说 GH 相关的我通通都不想讲。因为我讲了20遍快吐了。即便我现在很多更新版，是从来没对外公布的细节，但是在公司内部已经讲过很多次。所以我身体拒绝写作！

所以我用了一个变通方式。现在能用转写嘛。我发现半小时我就可以讲10000字。

所以干脆....用讲的.....。

再来是，我有定期发表的习惯。不管是在内部或外部。而且绝大多数有投影片或者录影。在三年前我开始职业讲课后，甚至有一个每一场演讲都录影的习惯。

于是我去把我所有的录影都翻出来，全部送迅飞 XDDDD。

果然直接拉出了高达 20 万字的原始材料 XDDDDD

用这方法太有效率了。我甚至一天录五集都可以，根本随便乱讲。

录完我就剪粗稿（没编辑过直接进 markdown），只是粗切而已。

所以 github 上面一大堆乱七八糟没编过的外星文，只有我自己看得懂。

但是光重构这些文章。我每天进度就真的很不错。一天至少出 7000 字的完稿是可能的....
